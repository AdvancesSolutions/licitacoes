            ...
            <div>
              ...
              <div class="login-main">
                <form class="theme-form">
                  ...
                  <p>Digite seu email e senha para fazer login</p>
                  ...
                  <div class="form-group mb-0">
                    ...
                    </div><router-link class="link" to="/authentication/forgetpassword"> Esqueceu a senha?</router-link>
                    <div class="text-end mt-3">
                      <button class="btn btn-primary btn-block w-100" type="submit" @click.prevent="login">Entrar</button>

                    </div>
                  </div>
                  <h6 class="text-muted mt-4 or">Ou entre com</h6>
                  ...
                  <p class="mt-4 mb-0 text-center">Não tem conta?<a class="ms-2" href="sign-up.html">Criar
                      Conta</a></p>
                </form>
