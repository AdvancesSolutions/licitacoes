        ...
        <ul class="sidebar-links custom-scrollbar" id="myDIV"
            ...
            <li class="back-btn">
                ...
                <div class="mobile-back text-end">
                    <span>Voltar</span><i class="fa fa-angle-right ps-2" aria-hidden="true"></i>
                </div>
            </li>
    ...
    watch: {
        width() {
            ...
            if (window.innerWidth < 992) {
                ...
                if (pageWrapper) {
                    pageWrapper.className = 'page-wrapper ' + newlayout;
                }
                this.$store.state.menu.margin = 0;
            } else {
                const pageWrapper = document.querySelector('.page-wrapper');
                if (pageWrapper) {
                    pageWrapper.className = 'page-wrapper ' + this.layoutobject;
                }
            }
