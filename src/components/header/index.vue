          ...
          <swiper-slide  class="h-100" >
            <div class="d-flex h-100">
              ...
              <h6 class="mb-0 f-w-400">
                <span class="font-primary">Não Perca! </span><span class="f-light">Nossa nova atualização foi lançada.</span></h6><i class="icon-arrow-top-right f-light"></i>
            </div>
          </swiper-slide>
          <swiper-slide class="h-100">
            <div class="d-flex h-100">
              <img src="@/assets/images/giftools.gif" alt="gif">
              <h6 class="mb-0 f-w-400">
                <span class="f-light">Algo que você ama está em promoção! </span></h6><a class="ms-1" href="https://1.envato.market/3GVzd" target="_blank">Comprar agora !</a>
            </div>
          </swiper-slide>
        </swiper>
    </div>
