    ...
    <div class="row">
            ...
            <div class="header-top">
              ...
              <div class="dropdown icon-dropdown">
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="userdropdown"><a class="dropdown-item"
                    href="#">Semanal</a><a class="dropdown-item" href="#">Mensal</a><a class="dropdown-item"
                    href="#">Anual</a></div>
              </div>
            </div>
          </div>
      ...
      <div class="col-xl-12">
        <div class="card growth-wrap">
          <div class="card-header card-no-border pb-0">
            <div class="header-top">
              <h5>Crescimento de Seguidores</h5>
              <div class="dropdown icon-dropdown">
          ...
          <div class="card-body">
            <div class="growth-wrapper">
              <apexchart height="150" type="line" :options="chartOptions" :series="chartSeries">
              </apexchart>
            </div>
          </div>
        </div>
...
export default {
  ...
  computed: {
    chartOptions() {
      return JSON.parse(JSON.stringify(this.apexDashboard.options6));
    },
    chartSeries() {
      return JSON.parse(JSON.stringify(this.apexDashboard.series6));
    }
  }
}
</script>