                          ...
                          <div class="card">
                            <div class="card-body">
                              ...
                              <div class="timeline-content">
                                <p>A única maneira de fazer algo em profundidade é trabalhar duro. Sempre pensei na camiseta como o Alfa do alfabeto da moda. Meu café da manhã é muito importante. Tudo que faço é uma questão de coração, corpo e alma.</p>
                                ...
                                <div class="social-chat">
                                  <div class="your-msg">
                                    <div class="media"><img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="../../../assets/images/user/1.jpg">
                                      <div class="media-body"><span class="f-w-600">Jason Borne <span>1 Ano Atrás <i class="fa fa-reply font-primary"></i></span></span>
                                        <p>estamos trabalhando para dançar e cantar músicas. este carro é muito incrível para os jovens. por favor vote neste carro e curta nossa postagem</p></div>
                                    </div>
                                  </div>
                                  <div class="other-msg">
                                    <div class="media"><img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="../../../assets/images/user/2.png">
                                      <div class="media-body"><span class="f-w-600">Alexendra Dhadio <span>1 Mês Atrás <i class="fa fa-reply font-primary"></i></span></span>
                                        <p>sim, realmente um carro muito incrível, vejo os recursos deste carro no site oficial da #Mercedes-Benz e fico realmente impressionado :-)</p></div>
                                    </div>
                                  </div>
                                  <div class="other-msg">
                                    <div class="media"><img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="../../../assets/images/user/3.png">
                                      <div class="media-body"><span class="f-w-600">Olivia Jon <span>15 Dias Atrás <i class="fa fa-reply font-primary"></i></span></span>
                                        <p>eu gosto de carros lexus, carros lexus são os mais bonitos com recursos incríveis, mas este carro é realmente excepcional que lexus</p></div>
                                    </div>
                                  </div>
                                  <div class="your-msg">
                                    <div class="media"><img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="../../../assets/images/user/1.jpg">
                                      <div class="media-body"><span class="f-w-600">Issa Bell <span>1 Ano Atrás <i class="fa fa-reply font-primary"></i></span></span>
                                        <p>estamos trabalhando para dançar e cantar músicas. este carro é muito incrível para os jovens. por favor vote neste carro e curta nossa postagem</p></div>
                                    </div>
                                  </div>
                                  <div class="text-center"><a class="f-w-600" href="javascript:void(0)">Mais Comentários</a></div>
                                </div>
                                                                  <div class="comments-box">
                                    <div class="media"><img class="img-50 img-fluid m-r-20 rounded-circle" alt="" src="../../../assets/images/user/1.jpg">
                                      <div class="media-body">
                                        <div class="input-group text-box">
                                          <input class="form-control input-txt-bx" type="text" name="message-to-send" placeholder="Poste seus comentários">
