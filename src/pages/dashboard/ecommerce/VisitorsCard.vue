    ...
    <div class="card visitor-card">
        <div class="card-header card-no-border">
            <div class="header-top">
                <h5 class="m-0">
                    Visitantes<span class="f-14 font-primary f-w-500 ms-1">
                ...
                <div class="card-header-right-icon">
                    <div class="dropdown icon-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="visitorButton">
                            <a class="dropdown-item" href="#">Hoje</a><a class="dropdown-item" href="#">Amanhã</a><a class="dropdown-item" href="#">Ontem</a>
                        </div>
                    </div>
                </div>
            </div>
