    ...
    <div class="card papernote-wrap">
        <div class="card-header card-no-border">
            <div class="header-top">
                <h5>Relatório de Licitações</h5>
                <a class="f-light d-flex align-items-center" href="#">Ver relatório <i class="f-w-700 icon-arrow-top-right"></i></a>
            </div>
        </div>
        <div class="card-body pt-0">
            ...
            <div class="note-content mt-sm-4 mt-2">
                <p>
                    Sistema completo para gestão de licitações públicas com
                    acompanhamento em tempo real e relatórios detalhados.
                </p>
                ...
                <div class="mt-sm-4 mt-2 user-details">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <span class="f-light f-w-500">(Valor Total)</span>
                    </div>
                </div>
            </div>
        </div>
