            ...
            <div class="row">
                <div class="col-xxl-12 col-xl-7 col-sm-6 box-col-6">
                    <div class="portfolio-chart-container">
                        <apexchart height="298.7" type="radialBar" :options="chartOptions" :series="chartSeries"></apexchart>
                    </div>
                </div>
...
export default {
    ...
    computed: {
        chartOptions() {
            return JSON.parse(JSON.stringify(this.cryptoDashboard?.options7));
        },
        chartSeries() {
            return JSON.parse(JSON.stringify(this.cryptoDashboard?.series7));
        }
    }
};
</script>
