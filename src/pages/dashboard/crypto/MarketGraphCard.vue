            ...
            <div class="row m-0 overall-card">
                <div class="col-xxl-8 col-xl-7 col-md-8 col-sm-7 p-0 box-col-7 col-ed-7 ">
                    <div class="market-chart-container">
                        <apexchart height="315" type="line" :options="chartOptions" :series="chartSeries"></apexchart>
                    </div>
                </div>
...
export default {
    ...
    computed: {
        chartOptions() {
            return JSON.parse(JSON.stringify(this.cryptoDashboard?.options6));
        },
        chartSeries() {
            return JSON.parse(JSON.stringify(this.cryptoDashboard?.series6));
        }
    }
}
</script>
